# Diversity and Inclusion App Template
...
![Diversity and Inclusion compose message screen](https://github.com/OfficeDev/microsoft-teams-apps-diversityandinclusion/wiki/images/CompanyCommunicatorCompose.png)
...
Begin with the [Solution overview](https://github.com/OfficeDev/microsoft-teams-apps-diversityandinclusion/wiki/Solution-overview) to read about what the app does and how it works.

When you're ready to try out Diversity and Inclusion, or to use it in your own organization, follow the steps in the [Deployment guide](https://github.com/OfficeDev/microsoft-teams-apps-diversityandinclusion/wiki/Deployment-guide).
